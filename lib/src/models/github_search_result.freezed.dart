...
mixin _$GitHubSearchResult {
  ...
  TResult when<TResult extends Object?>(
    TResult Function(List<Repo> repo) $default, {
...
class _$Data implements Data {
  ...
  @override
  String toString() {
    return 'GitHubSearchResult(user: $repo)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(repo));
...
abstract class Data implements GitHubSearchResult {
  const factory Data(List<Repo> repo) = _$Data;
